...
Full-stack MERN auction app with React, Tailwind CSS, Node.js, Express, MongoDB Atlas, and [Socket.io](http://Socket.io).
## Project Structure
```txt
backend/
  src/
...
- Live [Socket.io](http://Socket.io) bid updates and highest-bidder highlight.
...
make good looking readme for my this project and emojies and all add frontend url link also [IIIT Nagpur Premier League Auction System](https://npl-iiitn.vercel.app/) https://npl-iiitn.vercel.app/
